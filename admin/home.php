...
<html>
	...
	<body>
		...
		<div id="menubar">
			<div id="menu">
				<ul>
					<li><a href="home.php"><i class="fa fa-home" style="font-size:18px;color:blue"></i>  Home</a></li>
					<li><a href="home.php"><i class="fa fa-plus" style="font-size:18px;color:blue"></i>  Hospital  <i class="fa fa-sort-down" style="font-size:18px;color:blue"></i></a>
						<ul>
							<li><a href="home.php"> Shaheed Ziaur Rahman Medical College Hospital (SZMCH)</a>
								<ul>
							...
							<li><a href="home.php">IBN SINA Diagnostic & Consultation Center</a>
							<ul>
							...
							<li><a href="home.php">Popular Diagnostic Centre</a>
							<ul>
					...
					<li><a href="home.php">Department <i class="fa fa-sort-down" style="font-size:18px;color:blue"></i></a>
						<ul>
							<li><a href="home.php">ENT Specialist</a>
								<ul>
							...
							<li><a href="home.php">Eye Specialist</a>
							<ul>
							...
							<li><a href="home.php">Child Specialist</a>
							<ul>
							...
							<li><a href="home.php">Heart Specialist</a>
							<ul>
					...
					<li><a href="home.php"><i class="fa fa-user" style="font-size:18px;color:blue"></i>  ADD <i class="fa fa-sort-down" style="font-size:18px;color:blue"></i></a>
						<ul>
							<li><a href="doctorregister.php">Add Doctor</a></li>
							<li><a href="removedoc.php">Remove Doctor</a></li>
							<li><a href="userregister.php">Add User</a></li>
							<li><a href="removepatient.php">Remove User</a></li>
						 </ul>
					</li>
		  ...
		  <h2>
			...
			<div id="right-panel">        
				<div id="login">         
					<div id="logmenu">
						<ul>
							<li><a href="viewpatient.php"> View User</a></li>          
						</ul>
					</div>
				</div>
        ...
        <img src="css/ambulance-scene-low_orig.gif" width="100%" height="250" ></img>
          <div class="ambulence"><center><h3><br>Call Ambulence Service</h3></center>
			...
			<div id="right-section">
				<div>
					<div id="topbar">
						<p><br><br>This website is a smart appointment booking system that provides patients or any user an easy way of booking 
									a doctor’s appointment online. This is a web based application that overcomes the issue of managing and booking appointments 
									according to user’s choice or demands. The task sometimes becomes very tedious for the compounder or doctor himself in manually 
									allotting appointments for the users as per their availability.</p><br>
			
									<p><u><h2><marquee>Health Tips</marquee></u></h2></p>
									<p><b>1. </b>Don't drink sugar calories.</p>
									<p><b>2. </b>Eat nuts.</p>
									<p><b>3. </b>Avoid processed junk food (eat real food instead).</p>
									<p><b>4. </b>Don't fear coffee.</p>
									<p><b>5. </b>Drink some water, especially before meals.</p>
					</div>
				</div>
				
				<div class="rotating-box">
					<div class="single-rb">
						<div class="front-side"><img src="css/background3.gif" alt=""></div>
						<div class="right-side"><img src="css/background2.gif" alt=""></div>
						<div class="back-side"><img src="css/background4.gif" alt=""></div>
						<div class="left-side"><img src="css/background.gif" alt=""></div>
