          ...
          <div class="ambulence"><center><h3><br>Call Ambulence Service</h3></center>
			...
			<div id="topbar">
				...
				<div>
					...
					<?php
					$no=1;
					while($registerform=mysql_fetch_assoc($records)){
						echo"<tr>";
						echo "<td>".$no."</td>";
						echo "<td>".$registerform['name']."</td>";
						echo "<td>".$registerform['blood_group']."</td>";
						echo "<td>".$registerform['gender']."</td>";
						echo "<td>".$registerform['age']."</td>";
						echo "<td>".$registerform['contact_number']."</td>";
						echo "<td><a href=removepatientprocess.php?id=".$registerform['ID'].">Remove</a></td>";
						$no++;
					}
					?>
